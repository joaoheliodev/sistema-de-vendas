  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-white uppercase italic tracking-tight">Nova Aula</h1>
          <p className="text-zinc-500 font-mono text-sm">[ ADICIONAR NOVA AULA ]</p>
        </div>
      </div>

      <AulaForm modules={modules} />
    </div>
  );
}
