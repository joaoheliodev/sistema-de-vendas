...
-- CreateEnum
CREATE TYPE "VideoProvider" AS ENUM ('YOUTUBE', 'VIMEO', 'BUNNY');
...
-- CreateIndex
CREATE UNIQUE INDEX "CourseAccess_kiwifyOrderId_key" ON "CourseAccess"("kiwifyOrderId");
...
-- AddForeignKey
ALTER TABLE "Download" ADD CONSTRAINT "Download_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lesson"("id") ON DELETE CASCADE ON UPDATE CASCADE;
